...
def get_kernel(kernel_name: str) -> Tuple:
    ...
    :params kernel_name: the kernel to use. Current implemented kernels are
            - EINSUM: compute operations without forming A using `einsum`.
    ...
    :returns: tuple of Callable (data_mvp, data_t_mvp, grad, hessian_mvp, bd_hessian_mvp), where
        - 'data_mvp' computes products of the form 'A v'
        - 'data_t_mvp' computes transpose products 'A.T w'
        - 'hessian_mvp' computes Hessian-vector products 'H v'
...
def get_matrix_builders(kernel_name: str) -> Tuple:
    ...
    :params kernel_name: the kernel to use. Current implemented kernels are
            - EINSUM: compute matrices using `einsum`.
    ...
    :returns: tuple of Callable (data, hessian, bd_hessian), where
        - 'data_builder' computes the expanded data matrix 'A'
        - 'hessian' computes the Hessian of the squared loss, 'A.T A'.
