...
from cvx_nn.models import get_model
from cvx_nn.methods import get_method
from cvx_nn.datasets import load_dataset
...
def run_experiment(
    ...
    opt_procedure = get_method(logger, rng, model, train_set, exp_dict["method"])
...
def run_active_set_experiment(
    ...
    nc_model = get_model(logger, rng, train_set, active_set_conf["model"], src_model)
