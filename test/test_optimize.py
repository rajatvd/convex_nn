"""End-to-end tests for :module:`convex_nn.optimize`.

These tests exercise the internal models and optimization routines in :module:`convex_nn.private` as well as the
interface between the public and private modules :module`convex_nn.private.interface`.
...
from convex_nn.optimize import optimize, optimize_model, optimize_path
...
class TestDataFormats(unittest.TestCase):
    ...
    def test_scalar_targets(self):
        """Test :func:`convex_nn.optimize.optimize` with scalar targets."""
    ...
    def test_numpy(self):
        """Test :func:`convex_nn.optimize.optimize` with data as NumPy ndarrays."""
    ...
    def test_lists(self):
        """Test :func:`convex_nn.optimize.optimize` with data in list of lists format."""
    ...
    def test_torch(self):
        """Test :func:`convex_nn.optimize.optimize` with data as PyTorch tensors."""
    ...
    def test_no_test_data(self):
        """Test :func:`convex_nn.optimize.optimize` without any test data."""
        cvx_model, metrics = optimize(
            "gated_relu",
            self.max_neurons,
            self.X_train,
...
class TestFunctionalInterface(unittest.TestCase):
    """Test simple functional interface to `convex_nn`."""
...
class TestOOInterface(unittest.TestCase):
    """Test object-oriented interface to `convex_nn`."""
